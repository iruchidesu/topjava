    ...
    public ModelAndView defaultErrorHandler(HttpServletRequest req, Exception e) throws Exception {
        ...
        ModelAndView mav = new ModelAndView("exception",
                Map.of("exception", rootCause,
                        "message", rootCause.getLocalizedMessage() == null ? rootCause.getClass().getName() : rootCause.getLocalizedMessage(),
                        "typeI18N", messageSourceAccessor.getMessage(ErrorType.APP_ERROR.getErrorCode()),
                        "status", httpStatus));
