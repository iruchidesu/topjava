...
public abstract class AbstractControllerTest {
    ...
    protected ResultMatcher getTypeValue(ErrorType type) {
        return jsonPath("$.type").value(type.name());
    }

    protected ResultMatcher getDetailValue(String msg) {
        return jsonPath("$.details").value(messageSourceAccessor.getMessage(msg, ruLocale));
    }
}
